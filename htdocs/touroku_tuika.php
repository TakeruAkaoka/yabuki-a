...
if (isset($_POST['subject']) && isset($_FILES['imgdat'])) {
  ...
  $sql = 'INSERT INTO posts (subject,teacher,semesuta,tanni,kimatu,tyuukan,kyoukasyo,syusseki,teisyutu,flag, imgdat) VALUES (:subject,:teacher,:semesuta,:tanni,:kimatu,:tyuukan,:kyoukasyo,:syusseki,:teisyutu,:flag, :imgdat)';
